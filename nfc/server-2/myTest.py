...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(330, 50, 81, 31))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(15)
        ...
        self.textBrowser.setGeometry(QtCore.QRect(10, 140, 531, 231))
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_2.setText(_translate("Form", "结  束"))
