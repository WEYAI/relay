...
class RKE_RELAY(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        aparse.add_argument("-f", "--ubx_rx_freq", type= float,default="433", help="")
        ...
        self.lfrx_freq = lfrx_freq = 25e6
        self.lf_gain = lf_gain = 5

        ##################################################
        # Blocks
        ##################################################
        self._ubx_tx_gain_range = Range(0, 31, 1, 30, 200)
        self._ubx_tx_gain_win = RangeWidget(self._ubx_tx_gain_range, self.set_ubx_tx_gain, 'ubx_tx_gain', "counter_slider", int)
        self.top_layout.addWidget(self._ubx_tx_gain_win)
        self._ubx_rx_gain_range = Range(0, 31, 1, 30, 200)
        self._ubx_rx_gain_win = RangeWidget(self._ubx_rx_gain_range, self.set_ubx_rx_gain, 'ubx_rx_gain', "counter_slider", int)
        self.top_layout.addWidget(self._ubx_rx_gain_win)
        self._lf_gain_range = Range(0, 30, 0.1, 5, 200)
        self._lf_gain_win = RangeWidget(self._lf_gain_range, self.set_lf_gain, 'lf_gain', "counter_slider", float)
        self.top_layout.addWidget(self._lf_gain_win)
        ...
        self.uhd_usrp_source_0.set_center_freq(lfrx_freq + offset, 0)
        self.uhd_usrp_source_0.set_gain(10, 0)
        self.uhd_usrp_source_0.set_antenna('A', 0)
        self.uhd_usrp_source_0.set_center_freq(ubx_rx_freq  + offset, 1)
        self.uhd_usrp_source_0.set_gain(ubx_rx_gain, 1)
        ...
        self.uhd_usrp_sink_0.set_center_freq(lftx_freq + offset, 0)
        self.uhd_usrp_sink_0.set_gain(100, 0)
        self.uhd_usrp_sink_0.set_antenna('A', 0)
        self.uhd_usrp_sink_0.set_center_freq(ubx_tx_freq  + offset, 1)
        self.uhd_usrp_sink_0.set_gain(ubx_tx_gain, 1)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(lf_gain)
        ...
        self.connect((self.uhd_usrp_source_0, 1), (self.uhd_usrp_sink_0, 1))
    ...
    def set_ubx_tx_gain(self, ubx_tx_gain):
        ...
        self.uhd_usrp_sink_0.set_gain(self.ubx_tx_gain, 1)
    ...
    def set_ubx_tx_freq(self, ubx_tx_freq):
        ...
        self.uhd_usrp_sink_0.set_center_freq(self.ubx_tx_freq  + self.offset, 1)
    ...
    def set_ubx_rx_gain(self, ubx_rx_gain):
        ...
        self.uhd_usrp_source_0.set_gain(self.ubx_rx_gain, 1)
    ...
    def set_ubx_rx_freq(self, ubx_rx_freq):
        ...
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.ubx_rx_freq  + self.offset, self.samp_rate)
        self.uhd_usrp_source_0.set_center_freq(self.ubx_rx_freq  + self.offset, 1)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.lfrx_freq  + self.offset, self.samp_rate)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.ubx_rx_freq  + self.offset, self.samp_rate)
    ...
    def set_offset(self, offset):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.lfrx_freq  + self.offset, self.samp_rate)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.ubx_rx_freq  + self.offset, self.samp_rate)
        self.uhd_usrp_sink_0.set_center_freq(self.lftx_freq + self.offset, 0)
        self.uhd_usrp_sink_0.set_center_freq(self.ubx_tx_freq  + self.offset, 1)
        self.uhd_usrp_source_0.set_center_freq(self.lfrx_freq + self.offset, 0)
        self.uhd_usrp_source_0.set_center_freq(self.ubx_rx_freq  + self.offset, 1)
    ...
    def get_lf_gain(self):
        return self.lf_gain

    def set_lf_gain(self, lf_gain):
        self.lf_gain = lf_gain
        self.blocks_multiply_const_vxx_0.set_k(self.lf_gain)
