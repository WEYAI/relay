...
class RKE_RELAY(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._lfrx_freq_range = Range(10e6, 30e6, 1e6, 25e6, 200)
        self._lfrx_freq_win = RangeWidget(self._lfrx_freq_range, self.set_lfrx_freq, 'lfrx_freq', "counter_slider", float)
        self.top_layout.addWidget(self._lfrx_freq_win)
