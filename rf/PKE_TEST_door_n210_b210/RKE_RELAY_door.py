...
class RKE_RELAY(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        aparse.add_argument("-f", "--ubx_tx_freq", type=float,default="433", help="")
        ...
        self._ubx_rx_gain_win = RangeWidget(self._ubx_rx_gain_range, self.set_ubx_rx_gain, 'tx_gain_range', "counter_slider", int)
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.blocks_multiply_const_vxx_1_0 = blocks.multiply_const_cc(lf_gain)
    ...
    def set_lf_gain(self, lf_gain):
        ...
        self.blocks_multiply_const_vxx_1_0.set_k(self.lf_gain)
